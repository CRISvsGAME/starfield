...
const starfieldUrl = "https://cdn.jsdelivr.net/npm/@crisvsgame/starfield@1.2.0/dist/index.min.js";
const chromaUrl = "https://cdn.jsdelivr.net/npm/@crisvsgame/chroma@1.1.0/dist/index.min.js";
const typewriterUrl = "https://cdn.jsdelivr.net/npm/@crisvsgame/typewriter@1.0.1/dist/index.js";

const [starfieldModule, chromaModule, typewriterModule] = await Promise.all([loadModule("Starfield", starfieldUrl), loadModule("Chroma", chromaUrl), loadModule("Typewriter", typewriterUrl)]);

const Starfield = starfieldModule?.Starfield;
const Chroma = chromaModule?.Chroma;
const Typewriter = typewriterModule?.Typewriter;

try {
    if (typeof Starfield !== "function") {
        throw new Error("Starfield is not available.");
    }

    if (typeof Chroma !== "function") {
        throw new Error("Chroma is not available.");
    }
